        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <?php echo form_open_multipart('C_daftar/edit'); ?>
                            <?php echo form_hidden('kode',$daftar[0]->kode); ?>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="alamat" id="alamat" cols="30" rows="4" placeholder="Alamat Here" class="form-control" value=""><?php echo $daftar[0]->alamat; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Email</label>
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control" name="email" placeholder="Email Name Here" value="<?php echo $daftar[0]->email; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nomor HP</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="no_hp" placeholder="Nomor Here" value="<?php echo $daftar[0]->no_hp; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="no_hp_ortu" placeholder="Nomor Ortu Here" value="<?php echo $daftar[0]->no_hp_ortu; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
